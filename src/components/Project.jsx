...
const Project = ({ name, image, website, githubSite }) => {
  return (
    <div data-aos="fade-up" className="hover:-translate-y-1 duration-300 max-w-[350px] p-5 border border-solid border-[#0088BB] rounded-lg bg-gray-900 bg-opacity-50">
