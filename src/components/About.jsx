...
const About = () => {
  return (
    <section className='pt-[25px] pb-[25px]'>
        ...
        <p className='indent-8 text-[18px] leading-tight max-w-[75ch] text-justify items-center justify-center mx-auto font-semibold px-10'>
          Another project I worked on was a horoscope application that delivered personalized astrological readings to users. I utilized the RapidAPI to fetch relevant astrological data and displayed it in a user-friendly interface that made the application accessible to everyone.
        </p>
        <p className='indent-8 text-[18px] leading-tight max-w-[75ch] text-justify items-center justify-center mx-auto font-semibold px-10'>
          My most recent project is a web3 marketplace built using Solidity. This platform enables sellers and buyers to sell and buy goods without a third party to monitor, making transactions more secure, transparent, and efficient. I am constantly seeking new ways to explore the potential of blockchain technology and how it can benefit society.
        </p>
        <p className='indent-8 text-[18px] leading-tight max-w-[75ch] text-justify items-center justify-center mx-auto font-semibold px-10'>
